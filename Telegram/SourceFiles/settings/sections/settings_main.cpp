...
void BuildSectionButtons(SectionBuilder &builder) {
	...
	builder.addSectionButton({
		.title = ::Ghostgram::I18n::TrValue(
			u"Ghostgram Settings"_q,
			u"Настройки Ghostgram"_q),
		.targetSection = GhostgramId(),
		.icon = { &st::menuIconGhost },
		.keywords = {
			u"ghostgram"_q, u"fork"_q,
			u"гостграм"_q, u"призрак"_q, u"настройки"_q,
		},
	});
